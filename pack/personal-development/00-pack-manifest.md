...
| PD.FORM.131 | Cyberhuman | FORM | Формализация киберчеловека как системы из биологического и технологического компонентов: четыре наблюдаемых результата — рабочий продукт, изменение человека, сохраняемое изменение IWE и новая совместная способность | draft |
